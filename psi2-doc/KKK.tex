...
\subsection{Funkciniai reikalavimai}
	\begin{enumerate}[label=\textbf{FR\arabic*}]
		\item Užsiregistravęs vartotojas gali prisijungti:
			...
			\end{enumerate}
		\item Norimų gauti knygų sarašas;
			\begin{enumerate}[label*=\textbf{.\arabic*}]
		    ...
		    \end{enumerate}
		\item Knygos užregistravimas sistemoje;
			\begin{enumerate}[label*=\textbf{.\arabic*}]
				...
				\item Vartotojo pridėtos knygos puslapyje pridėti oficialų aprašymą apie knygą;
			\end{enumerate}
		\item Įkeltų knygų paieška;
			\begin{enumerate}[label*=\textbf{.\arabic*}]
				\item Vartotojas gali ieškoti knygos sistemoje pagal ISBN kodą;
				\item Vartotojas gali ieškoti knygos raktinius žodžius;
