	...
	\subsection{Užduočių aprašymai}
		...
		\begin{enumerate}[label=\textbf{U\arabic*.}]
			...
			\item \textbf{Prisijungti;}
				Budamas pagrindiniame puslapyje, lankytojas įveda savo vartotojo vardą ar (elektroninį paštą) ir slaptažodį i tam skirtus laukelius, bei spaudžia prisijungti.
				Sistema patikrina ar vartotojas su tokiu prisijungimo vardu ar el. paštu yra vartotojų sąraše duomenų bazėje.
				...
				\textbf{Alternatyvūs scenarijai:}
				\begin{itemize}
					\item Jei vartotojas su tokiais duomenimis nerastas pranešimas apie tai;
			...
			\item \textbf{Ieškoti knygos knygų duomenų bazėje}\\
				...
				\begin{itemize}
					...
					\item Jei, dėl kokių nors priežasčių, sistemai nepavyksta susisiekti su knygų duomenų baze, arba 
						gautas neigiamas atsakymas arba nerasta nei vienos knygos, lankytojui parodomas pranešimas apie tai;
...
\section{Techninė sistemos architektūra}
	...
	\subsection{Sistemos komponentai}
		...
		bei už prieiga prie išorinės knygų duomenų bazės (naudojant pvz. google books api). 
		Visi komponentai yra vaizduojami komponentų diagramoje (žr.	%FIXME: add reference to img
		\begin{figure}[H]
			\centering
	...
	\subsection{Sistemos komponentų išdėstymas tinkle}
		Sistemos komponentų išdėstymą vykdymo aplinkose vaizduoja diegimo diagrama (žr. ).	%FIXME: add reference to img
		Sistemai įgyvendinti reikia web serverio, duomenų bazės bei išorinės (KKK sistemai nepriklausančios) 
		knygų duomenų bazės, kurios prieeinamumas būtu pakankamas.
...
\section{Peržiūros metu rastos klaidos}
	...
	\subsection{Preliminari projekto peržiūra}
		Ši peržiūra yra vykdoma, atlikus robastiškumo analizę.	%TODO: add more
		\begin{itemize}
