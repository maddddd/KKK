	...
	\subsection{Užduočių aprašymai}
		...
		\begin{enumerate}[label=\textbf{U\arabic*.}]
			...
			\item \textbf{Užsiregistruoti};		
				...
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.8]{img/U1-sequence.png}
					\caption{U1 sekų diagrama}
					\label{img:psi2-u1-sequence}
				\end{figure}
			\item \textbf{Prisijungti;}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.8]{img/U2-sequence.png}
					\caption{U2 sekų diagrama}
					\label{img:psi2-u2-sequence}
				\end{figure}
			...
			\item \textbf{Pridėti pasirinktą knygą prie pageidavimų sąrašo}\\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.8]{img/U7-sequence.png}
			...
			\item \textbf{Peržiūreti vartotojo puslapį;}\\
				...
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.6]{img/8seq.png}
					\caption{U8 sekų diagrama}
					\label{img:psi2-u8-sequence}
				\end{figure}
			...
			\item \textbf{Įvertinti mainus;}\\ % fiksuoti statistiką
				...
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.6]{img/13seq.png}
					\caption{U13 sekų diagrama}
					\label{img:psi2-u13-sequence}
				\end{figure}
			\item \textbf{Pasiūlyti savo įkeltą knygą kitam vartotojui;}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.6]{img/14seq.png}
					\caption{U14 sekų diagrama}
					\label{img:psi2-u14-sequence}
				\end{figure}
		\end{enumerate}
