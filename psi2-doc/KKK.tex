...
\section{Reikalavimai}
	...
	%TODO: prideti reikalavimus del apsikeitimo proceso, kad fiksuotu statistiką, atitinkamai pataisyti ir dalykines srities modeli
...
\section{Struktūrinis dalykinės srities modelis}
	...
	\subsection{Žodynas}
		\begin{enumerate}[label=\textbf{E\arabic*.}]
			...
			\item Vartotojo statistika - išsami vartotojo statistika apie vartotoją;
		\end{enumerate}
